...
from datasets import Dataset as da, DatasetDict
...
class UTSDataset(Dataset):
    ...
    def find_dataset_index(self, index):
        low, high = 0, len(self.n_window_list) - 1
        ...
        return low  # 返回下一个有效的 dataset_index


    def __getitem__(self, index):
        
        dataset_index = self.find_dataset_index(index)
        ...
        return seq_x, seq_y, mark_x, mark_y
