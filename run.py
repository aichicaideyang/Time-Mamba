...
if __name__ == '__main__':
    ...
    parser.add_argument('--fm', type=bool, default=True, help='train a fm ?') 
    parser.add_argument('--zs', type=bool, default=False, help='zero shot ?') 


    parser.add_argument('--data', type=str, required=False, default='ETTm1', help='dataset type') 

    parser.add_argument('--model_id', type=str, required=False, default='TimeMamba_', help='model id')
    parser.add_argument('--model', type=str, required=False, default='TimeMamba',
    ...
    parser.add_argument('--window_size', type=int, default=8, help='window size selection')
    ...
    # patching phase
    parser.add_argument('--patch_len', type=int, default=32, help='patching length') 
    ...
    if args.is_training==1:
        ...
        exp = Exp(args)  # set experiments
        print('>>>>>>>testing : {}<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<'.format(setting))
        exp.test(setting, test=1) # auto regressive
